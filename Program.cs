...
namespace eLearning
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var careerItems = new CareerItem(2, "Aprenda OOP", "", null);
            var careerItems2 = new CareerItem(1, "Comece por aqui", "", null);
            var careerItems3 = new CareerItem(3, "Aprenda .NET", "", null);
